...
- A) Clicking on "stryke_project_notebook.ipynb" willl launch the tool.
...
- The annotations above and within cells will guide you through the process of fitting entrainment rates and running simulations.
